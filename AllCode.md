...
then begin
Alert(text(" model=RITMICFASTinstrument=","NQ shares=",longbuyingPower1 ," type=SOLD LONG-", FormatDate("dd-MM-yyyy", DateToJulian(Date)), "EXIT ON TAKE PROFIT 2",rtPosition, marketposition));
alertsGenerated  =2;
end;
end;
}
...
if alertsGenerated = 1
then begin
Alert(text(" model=RITMICFASTinstrument=","NQ shares=",longbuyingPower1 ," type=SOLD LONG-", FormatDate("dd-MM-yyyy", DateToJulian(Date)), "EXIT ON CROSS 2",rtPosition, marketposition));
alertsGenerated  =2;
end;
end;
}
...
Alert(text(" model=RITMICFAST instrument=","NQ shares=",longbuyingPower3 ," type=SOLD LONG-", FormatDate("dd-MM-yyyy", DateToJulian(Date)), "EXIT ON BREAK EVEN"));
alertsGenerated = 0;
rtPosition = 0;
end;
end;
...
if alertsGenerated = 1
then begin
Alert(text(" model=RITMICFAST instrument=","NQ shares=",shortbuyingPower1," type=BOUGHT SHORT-", FormatDate("dd-MM-yyyy", DateToJulian(Date)),"EXIT ON TAKE PROFIT 2",rtPosition, marketposition));
alertsGenerated  =2;
end;
end;
}
...
if alertsGenerated = 1 
then begin
Alert(text(" model=RITMICFASTinstrument=","NQ shares=",shortbuyingPower1 ," type=BOUGHT SHORT-", FormatDate("dd-MM-yyyy", DateToJulian(Date)), "EXIT ON CROSS 2"));
alertsGenerated  =2;
end;
end;
}
...
Alert(text(" model=RITMICFAST instrument=","NQ shares=",shortbuyingPower3 ," type=BOUGHT SHORT-", FormatDate("dd-MM-yyyy", DateToJulian(Date)), "EXIT ON BREAK EVEN"));
alertsGenerated  =0;
rtPosition = 0;
end;
end;
