	...
	emamiddata2 = XAverage(close of data2,MidLengthdata2);
	...
	//high and low level
	high3data2 = maxlist(high of data2 [1] );
	//low3data2 = minlist (close [1] of data2 , open [1], close [2] , open [2], close [3] , open [3], close [4] , open [4], close [5] , open [5] );
	...
	//and
	//vBlbHLOC > vBubHLOC * (1-maxgap5/100)
